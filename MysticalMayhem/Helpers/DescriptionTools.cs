...
namespace MysticalMayhem.Helpers
{
    ...
    {
        // Written by Vek. This is taken from old TTT versions.
        ...
        // This one is written by me. Auto-tags descriptions loaded by Owlcat's localization manager.
        internal static void TagForEncyclopedia(this LocalizedString _instance)
        {
            LocalizationManager.CurrentPack.PutString(_instance.GetActualKey(),
                TagEncyclopediaEntries(_instance.LoadString(LocalizationManager.CurrentPack, LocalizationManager.CurrentLocale)));
        }
    }
}